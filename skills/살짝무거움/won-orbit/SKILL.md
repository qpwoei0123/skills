...
metadata:
  version: 3.0.0
description: (v3.0.0) 레포를 SAFE/ARCH/DEP/BUILD/DATA/OPS/DOC 관점으로 점검하고 요청받은 기술 이슈를 GitHub/GitLab에 발행한다. "레포 점검해줘", "기술 부채 찾아줘", "의존성/CI/아키텍처 점검해줘", "이슈 자동 등록해줘", "$won-orbit" 요청에 사용한다. 특정 PR·diff 결함 리뷰와 단발성 수정은 review/code-review가 맡는다.
---
...
- `점검해줘`, `기술 부채 찾아줘`, `$won-orbit <repo>`는 분석과 결과 보고다.
...
$won-orbit . --suppress pipeline:owner/repo:BUILD:f-12345678
```
