...
```text
$won-context-review https://github.com/acme/payments/pull/123
$won-context-review 이 MR과 연결된 기획서를 읽고 사람이 결정해야 할 질문만 추려줘.
```
...
```bash
python3 scripts/validate_skills.py --skill won-context-review
```
