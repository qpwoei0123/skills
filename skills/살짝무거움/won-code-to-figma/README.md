...
```text
$won-code-to-figma 현재 localhost 대시보드를 이 Figma 파일로 옮겨줘.
목적지: https://www.figma.com/design/abc123/My-File?node-id=12-34
```

```text
$won-code-to-figma 현재 네 화면을 새 Figma 파일에 편집 가능한 레이어로 옮겨줘.
```
...
```bash
python3 scripts/validate_skills.py --skill won-code-to-figma
```
