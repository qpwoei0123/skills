...
대화·코드·diff의 관계를 근거가 연결된 단일 HTML로 설명합니다. Codex 표시 이름은 **코드 한눈**입니다.

## Quick Start

```text
$code-visualizer 방금 설명한 구조를 HTML로 보여줘.
$code-visualizer 이 기능의 요청부터 DB 저장까지를 한눈에 보여줘.
$code-visualizer 현재 diff의 구조 전후를 시각화해줘.
```
