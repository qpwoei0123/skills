...
이슈 본문 footer에 `format_version: repo-orbit/v2.1`가 찍힌다.
...
|---------------------|------|
| `repo-orbit/v1` 또는 없음 | 전체 본문 재작성 |
| `repo-orbit/v2.0.1` 이하 | 전체 본문 재작성 |
| `repo-orbit/v2.1` | 점수 유지, 본문 재작성 생략 |
...
`format_version: repo-orbit/v2.1` · `fingerprint: pipeline:{repo}:{view_id}:{finding_id}`
````
...
`format_version: repo-orbit/v2.1` · `fingerprint: pipeline:owner/repo:DEP:E1`
````
...
`format_version: repo-orbit/v2.1` · `fingerprint: pipeline:owner/repo:SAFE:E3`
````
...
- labels: `automation`
- 제목 형식 준수 (50자 이내)
- 본문 footer: `format_version: repo-orbit/v2.1`
